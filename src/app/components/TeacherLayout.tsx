          ...
          <div className="p-4 border-b border-[#E0E0E0] flex-shrink-0">
            <div className={`flex items-center px-4 py-3 ${!sidebarOpen && 'justify-center'}`}>
              <Avatar className={sidebarOpen ? "w-8 h-8 bg-[#E0E0E0]" : "w-[50px] h-[50px] bg-[#E0E0E0]"}>
                <AvatarFallback className="text-[#333333]">MJ</AvatarFallback>
              </Avatar>
              {sidebarOpen && (
                <div className="ml-3">
                  <div className="text-sm font-medium text-[#1A1A1A]">Maria Johnson</div>
                  <div className="text-xs text-[#757575]">Teacher</div>
                </div>
              )}
            </div>
          </div>
